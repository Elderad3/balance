...
import { DecimoTerceiroService } from '../decimo-terceiro/decimo-terceiro.service';
...
export class DecimoTerceiroComponent implements OnInit {
  ...
  menuContext: MenuContext = { titulo: 'Calcular Décimo Terceiro', descricao: 'Cálculo Detalhado do Décimo terceiro', modulo: 'Trabalhista' }
  salario: Salario
  ...
  constructor(private titleService: Title, private metaService: Meta, private decimoTerceiroService: DecimoTerceiroService) { }
  ...
  calcular() {
    this.decimoTerceiroService.saldoDecimoTerceiro(this.salario).forEach(verba => {
